...
export default {
  ...
  'menu.charge': '充值提现审核',
  'menu.charge.recharge': '充值审核',
  'menu.recharge': '充值提现',
  'menu.charge.excharge': '提现审核',
  'menu.recharge.recharge': '充值',
  'menu.recharge.putforward': '提现',
  'menu.dashboard.analysis': '分析页',
  'menu.dashboard.monitor': '监控页',
  'menu.dashboard.workplace': '工作台',
  'menu.accountmanager': '账户管理',
  'menu.accountmanager.agent': '代理账号管理',
  'menu.accountmanager.viplist': '会员管理',
  'menu.accountmanager.deleteagent': '已删除代理',
  'menu.accountmanager.deletevip': '已删除会员',
  'menu.accountmanager.adduseroragent': '添加帐号',
  'menu.report': '报表管理',
  'menu.report.agent': '代理日结表',
  'menu.report.vip': '会员日结表',
  'menu.report.recharge': '充值提现',
  'menu.report.onlineUser': '在线玩家',
  'menu.form': '表单页',
  ...
  'menu.recharge.recharge.info': '填写转账信息',
  'menu.recharge.recharge.confirm': '确认转账信息',
  'menu.recharge.recharge.result': '完成',
  'menu.list': '列表页',
  ...
  'menu.index.competition': '参与竞猜',
  'menu.competition': '参与竞猜',
};
