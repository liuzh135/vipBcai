export default {
  ...
  'menu.usercenter': 'Home',
  'menu.account.logout': 'logout',
  'menu.charge': 'Recharge List',
  'menu.charge.recharge': 'Recharge',
  'menu.recharge': 'Recharge',
  'menu.charge.excharge': 'Excharge List',
  'menu.recharge.recharge': 'recharge',
  'menu.recharge.putforward': 'put forward',
  'menu.dashboard.analysis': 'Analysis',
  'menu.dashboard.monitor': 'Monitor',
  'menu.dashboard.workplace': 'Workplace',
  'menu.accountmanager': 'Account Manager',
  'menu.accountmanager.agent': 'Agent Manager',
  'menu.accountmanager.viplist': 'Account List',
  'menu.accountmanager.deleteagent': 'Deleted Agent',
  'menu.accountmanager.deletevip': 'Deleted Account',
  'menu.accountmanager.adduseroragent': 'Add Accoun',
  'menu.report': 'Report Manager',
  'menu.report.agent': 'Agent Day Report',
  'menu.report.vip': 'Account Day Report',
  'menu.report.recharge': 'Recharge',
  'menu.report.onlineUser': 'Online Player',
  'menu.form': 'Form',
  ...
  'menu.recharge.recharge.info': 'write transfer information',
  'menu.recharge.recharge.confirm': 'confirm transfer information',
  'menu.recharge.recharge.result': 'finished',
  'menu.list': 'List',
  ...
  'menu.index.competition': 'Participate in guessing',
  'menu.competition': 'Participate in guessing',
};
